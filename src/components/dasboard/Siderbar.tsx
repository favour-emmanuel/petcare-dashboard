...
const Siderbar = () => (
  <div className="bg-apppureWhite border-r border-r-[#DAE3F8] pt-2 px-8 w-full max-w-[18rem]">
    ...
    <ul className="pt-8 border-b">
      ...
      <li className="bg-appBlue text-white py-2.5 px-3 w-[14rem] flex items-center rounded-md gap-5 text-sm my-2">
        <LuLayoutDashboard />
        Dashboard
      </li>
